...
"""
Connecting to 2 diff databases 
"""

conn1 = pymysql.connect(user='root', password='', db='compare_test2')
df_db_1 = pd.read_sql('select * from test_table', conn1)

conn2 = pymysql.connect(user='root', password='', db='compare_test2')
df_db_2 = pd.read_sql('select * from test_table_2', conn2)
