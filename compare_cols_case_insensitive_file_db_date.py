...
xlsx_cols = col_file.iloc[0]['target_col'].lower()

xlsx_cols_list = xlsx_cols.replace(" ",'').split(',') # name, age, roll

"""Source file location"""
df_xlsx = pd.read_excel('C:\\Users\\Goldy\\Desktop\\data.xlsx')
df_xlsx.columns= df_xlsx.columns.str.lower()
df_xlsx = df_xlsx[xlsx_cols_list]
...
for col in df_db.columns:
    if df_db[col].dtype == 'object':
        try:
            ...
            df_xlsx[col] = pd.to_datetime(df_xlsx[col])
        except:
